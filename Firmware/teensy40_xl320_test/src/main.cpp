...
void setup()
{
  ...
  HalfDuplexHardwareSerial.begin(115200);
  HalfDuplexHardwareSerial.setTimeout(delayBetweenSendReceive);

  // Initialise your robot
  robot.begin(HalfDuplexHardwareSerial); // Hand in the serial object you're using
